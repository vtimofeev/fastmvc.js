...
В более сложном варианте - модели могут быть производными от исходных моделей, и применять к данным различные функторы (filter,map,reduce),
отслеживая изменения исходных моделей и автоматически обновляясь.
