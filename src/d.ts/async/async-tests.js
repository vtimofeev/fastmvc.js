...
var count = 0;
async.whilst(function () { return count < 5; }, function (callback) {
    count++;
...
var qStarted = q.started;
var qPaused = q.paused;
var qProcessingCount = q.running();
var qIsIdle = q.idle();
...
q2.push('task1');
q2.push('task2', function (error, results) {
    console.log('Finished tasks: ' + results.join(', '));
});
q2.push(['task3', 'task4', 'task5'], function (error, results) {
    console.log('Finished tasks: ' + results.join(', '));
});
q2.unshift('task1');
q2.unshift('task2', function (error, results) {
    console.log('Finished tasks: ' + results.join(', '));
});
q2.unshift(['task3', 'task4', 'task5'], function (error, results) {
    console.log('Finished tasks: ' + results.join(', '));
});
var filename = '';
async.auto({
