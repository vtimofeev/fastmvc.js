...
result = _('test').tap(function (value) { console.log(value); });
result = _([1, 2, 3, 4]).tap(function (array) { console.log(array); });
result = _({ 'key1': 'test1', 'key2': 'test2' }).tap(function (array) { console.log(array); });
...
result = _([1, 2, 3]).first();
result = _([1, 2, 3]).first(2).value();
result = _([1, 2, 3]).first(function (num) {
    return num < 3;
}).value();
result = _(foodsOrganic).first('organic').value();
result = _(foodsType).first({ 'type': 'fruit' }).value();
result = _.head([1, 2, 3]);
...
result = _([1, 2, 3]).head();
result = _([1, 2, 3]).head(2).value();
result = _([1, 2, 3]).head(function (num) {
    return num < 3;
}).value();
result = _(foodsOrganic).head('organic').value();
result = _(foodsType).head({ 'type': 'fruit' }).value();
result = _.take([1, 2, 3]);
...
result = _([1, 2, 3]).take();
result = _([1, 2, 3]).take(2).value();
result = _([1, 2, 3]).take(function (num) {
    return num < 3;
}).value();
result = _(foodsOrganic).take('organic').value();
result = _(foodsType).take({ 'type': 'fruit' }).value();
...
result = _.range(0);
result = _.remove([1, 2, 3, 4, 5, 6], function (num) { return num % 2 == 0; });
...
result = _([1, 2, 1, 3, 1]).uniq().value();
result = _([1, 1, 2, 2, 3]).uniq(true).value();
result = _(['A', 'b', 'C', 'a', 'B', 'c']).uniq(function (letter) {
    return letter.toLowerCase();
}).value();
result = _([1, 2.5, 3, 1.5, 2, 3.5]).uniq(function (num) { return this.floor(num); }, Math).value();
result = _([{ 'x': 1 }, { 'x': 2 }, { 'x': 1 }]).uniq('x').value();
result = _([1, 2, 1, 3, 1]).unique().value();
result = _([1, 1, 2, 2, 3]).unique(true).value();
result = _(['A', 'b', 'C', 'a', 'B', 'c']).unique(function (letter) {
    return letter.toLowerCase();
}).value();
result = _([1, 2.5, 3, 1.5, 2, 3.5]).unique(function (num) { return this.floor(num); }, Math).value();
result = _([{ 'x': 1 }, { 'x': 2 }, { 'x': 1 }]).unique('x').value();
result = _.without([1, 2, 1, 0, 3, 1, 4], 0, 1);
result = _.xor([1, 2, 3, 4, 5], [5, 2, 10]);
result = _.xor([1, 2, 3, 4, 5], [5, 2, 10], [4, 5, 6]);
result = _([1, 2, 3, 4, 5]).xor([5, 2, 10]);
result = _([1, 2, 3, 4, 5]).xor([5, 2, 10], [4, 5, 6]);
result = _.zip(['moe', 'larry'], [30, 40], [true, false]);
result = _.unzip(['moe', 'larry'], [30, 40], [true, false]);
result = _(['moe', 'larry']).zip([30, 40], [true, false]).value();
result = _(['moe', 'larry']).unzip([30, 40], [true, false]).value();
// /* *************
//  * Collections *
//  ************* */
...
result = _.countBy([4.3, 6.1, 6.4], function (num) { return Math.floor(num); });
result = _.countBy([4.3, 6.1, 6.4], function (num) { return this.floor(num); }, Math);
result = _.countBy(['one', 'two', 'three'], 'length');
result = _([4.3, 6.1, 6.4]).countBy(function (num) { return Math.floor(num); });
result = _([4.3, 6.1, 6.4]).countBy(function (num) { return this.floor(num); }, Math);
...
result = _([1, 2, 3, 4, 5, 6]).filter(function (num) { return num % 2 == 0; }).value();
...
result = _([1, 2, 3, 4, 5, 6]).select(function (num) { return num % 2 == 0; }).value();
...
result = _([1, 2, 3, 4]).find(function (num) {
    return num % 2 == 0;
});
result = _(foodsCombined).find({ 'type': 'vegetable' });
result = _(foodsCombined).find('organic');
...
result = _.forEach({ 'one': 1, 'two': 2, 'three': 3 }, function (num) { console.log(num); });
result = _.forEach({ name: 'apple', type: 'fruit' }, function (value, key) { console.log(value, key); });
result = _.each([1, 2, 3], function (num) { console.log(num); });
result = _.each({ 'one': 1, 'two': 2, 'three': 3 }, function (num) { console.log(num); });
result = _.each({ name: 'apple', type: 'fruit' }, function (value, key) { console.log(value, key); });
result = _([1, 2, 3]).forEach(function (num) { console.log(num); });
result = _({ 'one': 1, 'two': 2, 'three': 3 }).forEach(function (num) { console.log(num); });
result = _([1, 2, 3]).each(function (num) { console.log(num); });
result = _({ 'one': 1, 'two': 2, 'three': 3 }).each(function (num) { console.log(num); });
result = _.forEachRight([1, 2, 3], function (num) { console.log(num); });
result = _.forEachRight({ 'one': 1, 'two': 2, 'three': 3 }, function (num) { console.log(num); });
result = _.eachRight([1, 2, 3], function (num) { console.log(num); });
result = _.eachRight({ 'one': 1, 'two': 2, 'three': 3 }, function (num) { console.log(num); });
result = _([1, 2, 3]).forEachRight(function (num) { console.log(num); });
result = _({ 'one': 1, 'two': 2, 'three': 3 }).forEachRight(function (num) { console.log(num); });
result = _([1, 2, 3]).eachRight(function (num) { console.log(num); });
result = _({ 'one': 1, 'two': 2, 'three': 3 }).eachRight(function (num) { console.log(num); });
result = _.groupBy([4.2, 6.1, 6.4], function (num) { return Math.floor(num); });
result = _.groupBy([4.2, 6.1, 6.4], function (num) { return this.floor(num); }, Math);
result = _.groupBy(['one', 'two', 'three'], 'length');
result = _.groupBy({ prop1: 4.2, prop2: 6.1, prop3: 6.4 }, function (num) { return Math.floor(num); });
result = _.groupBy({ prop1: 4.2, prop2: 6.1, prop3: 6.4 }, function (num) { return this.floor(num); }, Math);
result = _.groupBy({ prop1: 'one', prop2: 'two', prop3: 'three' }, 'length');
result = _([4.2, 6.1, 6.4]).groupBy(function (num) { return Math.floor(num); }).value();
result = _([4.2, 6.1, 6.4]).groupBy(function (num) { return this.floor(num); }, Math).value();
result = _(['one', 'two', 'three']).groupBy('length').value();
result = _({ prop1: 4.2, prop2: 6.1, prop3: 6.4 }).groupBy(function (num) { return Math.floor(num); }).value();
result = _({ prop1: 4.2, prop2: 6.1, prop3: 6.4 }).groupBy(function (num) { return this.floor(num); }, Math).value();
result = _({ prop1: 'one', prop2: 'two', prop3: 'three' }).groupBy('length').value();
result = _.indexBy(keys, 'dir');
result = _.indexBy(keys, function (key) { return String.fromCharCode(key.code); });
result = _.indexBy(keys, function (key) { this.fromCharCode(key.code); }, String);
...
result = _([1, 2, 3]).map(function (num) { return num * 3; }).value();
result = _({ 'one': 1, 'two': 2, 'three': 3 }).map(function (num) { return num * 3; }).value();
...
result = _([1, 2, 3]).collect(function (num) { return num * 3; }).value();
result = _({ 'one': 1, 'two': 2, 'three': 3 }).collect(function (num) { return num * 3; }).value();
...
result = _([4, 2, 8, 6]).max();
result = _(stoogesAges).max(function (stooge) { return stooge.age; });
result = _(stoogesAges).max('age');
result = _.min([4, 2, 8, 6]);
result = _.min(stoogesAges, function (stooge) { return stooge.age; });
result = _.min(stoogesAges, 'age');
result = _([4, 2, 8, 6]).min();
result = _(stoogesAges).min(function (stooge) { return stooge.age; });
result = _(stoogesAges).min('age');
result = _.pluck(stoogesAges, 'name');
result = _(stoogesAges).pluck('name').value();
...
result = _([1, 2, 3]).foldl(function (sum, num) {
    return sum + num;
});
...
result = _([1, 2, 3]).inject(function (sum, num) {
    return sum + num;
});
...
result = _([1, 2, 3, 4, 5, 6]).reject(function (num) { return num % 2 == 0; }).value();
result = _(foodsCombined).reject('organic').value();
result = _(foodsCombined).reject({ 'type': 'fruit' }).value();
...
result = _([1, 2, 3]).sortBy(function (num) { return Math.sin(num); }).value();
result = _([1, 2, 3]).sortBy(function (num) { return this.sin(num); }, Math).value();
result = _(['banana', 'strawberry', 'apple']).sortBy('length').value();
(function (a, b, c, d) { return _.toArray(arguments).slice(1); })(1, 2, 3, 4);
result = _.toArray([1, 2, 3, 4]);
(function (a, b, c, d) { return _(arguments).toArray().slice(1).value(); })(1, 2, 3, 4);
result = _([1, 2, 3, 4]).toArray().value();
...
result = _(function () { }).debounce(150);
jQuery('#postbox').on('click', _(function () { }).debounce(300, {
    'leading': true,
    'trailing': false
}));
source.addEventListener('message', _(function () { }).debounce(250, {
    'maxWait': 1000
}), false);
var returnedDebounce = _.throttle(function (a) { return a * 5; }, 5);
returnedThrottled(4);
result = _.defer(function () { console.log('deferred'); });
result = _(function () { console.log('deferred'); }).defer();
...
result = _.forOwn({ '0': 'zero', '1': 'one', 'one': '2' }, function (num, key) {
    console.log(key);
});
...
result = _({ 'one': 1, 'two': 2, 'three': 3 }).keys().value();
var mergeNames = {
    'stooges': [
        { 'name': 'moe' },
        { 'name': 'larry' }
...
result = _({ 'name': 'moe', 'age': 40 }).omit('age').value();
result = _({ 'name': 'moe', 'age': 40 }).omit(['age']).value();
result = _({ 'name': 'moe', 'age': 40 }).omit(function (value) {
    return typeof value == 'number';
}).value();
result = _.pairs({ 'moe': 30, 'larry': 40 });
result = _({ 'moe': 30, 'larry': 40 }).pairs().value();
...
result = _.times(3, function (n) { mage.castSpell(n); });
result = _.times(3, function (n) { this.cast(n); }, mage);
...
//# sourceMappingURL=lodash-tests.js.map